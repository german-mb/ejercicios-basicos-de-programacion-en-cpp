/*
15.	Se tiene un x monto de dinero por concepto de presupuesto del año de un Instituto, estas serán entregadas de la siguiente forma: Para Sistemas 20%, Administración 30%, contaduría 25% y el resto para Secretariado.
*/
#include <iostream>
using namespace std;
int main() {
